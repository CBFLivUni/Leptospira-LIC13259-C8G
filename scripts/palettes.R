...
#'
#' Palettes specific to this project
#' @export
project_palettes <- list(
  
  species_colours = c("#63E8F0", "#93E156", "#E74C48", "#63B2E5", "#DB2BEF", "#59B968", 
                       "#E5678C", "#827FEB", "#57ECA1", "#E7BBBE", "#649770", "#8BE6B3", 
                       "#3923FA", "#E17970", "#CEE6D5", "#5B57ED", "#A63BA9", "#E292AB", 
                       "#E7D337", "#E555BE", "#E4F437", "#9CD8F1", "#B5E1E3", "#DFC9A7", 
                       "#A1A54E", "#DC7BBB", "#E93ED7", "#D4853A", "#DF9ED1", "#575D9D", 
                       "#76F0DD", "#954D73", "#9FF1E8", "#B69E95", "#A6695C", "#E8DD7D", 
                       "#488796", "#70ED31", "#6C4DBA", "#D8E0F0", "#48C6E2", "#D89CEE", 
                       "#E6BEE7", "#6F2FE5", "#4FE265", "#4EC5B7", "#96F08D", "#B09FE1", 
                       "#80778F", "#A3B5BE", "#A46AC5", "#EFE3D8", "#B2B8E4", "#AADD99", 
                       "#E37AE6", "#5492E5", "#9A43E4", "#73B4BE", "#ED3088", "#8D2770", 
                       "#BF5EE6", "#DAC7D4", "#51ECC8", "#DBEE81", "#E6AF38", "#BEDF4F", 
                       "#DFF1C5", "#E7A688", "#E3BC79", "#91C4AB", "#D3DC9C"),
  
  species_colours2 = c("#EE318D", "#9FE55F", "#62C7C1", "#4C749D", "#9332F1", "#5EE5B8", 
                        "#A5E98A", "#C9E9E2", "#65EEDA", "#B4B779", "#DD9E84", "#82A7BB", 
                        "#E333E7", "#95C8B4", "#9EEDB5", "#EAE1EB", "#ED4DD2", "#708C72", 
                        "#E4E89F", "#CC9FED", "#7683E9", "#6FE92E", "#8F8CC5", "#EACFA7", 
                        "#DE8F2D", "#EEED2C", "#F1B3E4", "#5BE4F1", "#A56BC5", "#A0F3EA", 
                        "#B3B847", "#CDEE43", "#C2BCED", "#E599AC", "#5E48DE", "#A36185", 
                        "#9ADAF0", "#4DA175", "#EAE962", "#E3C2D3", "#D06C6F", "#49BAD7", 
                        "#997C82", "#8F7232", "#E9BD3C", "#554E98", "#62BE69", "#8D3068", 
                        "#D4BAAD", "#8668DD", "#E67A58", "#51E264", "#95CA98", "#62F09E", 
                        "#C192BF", "#E584E9", "#DF81BD", "#4C8E93", "#C1D9EC", "#6CBAEF", 
                        "#E8424F", "#E9688F", "#AEBCBE", "#E8BA76", "#BA59E6", "#EAE3D1", 
                        "#DCEDC0", "#E0EB84", "#5292E5", "#B548B6", "#E85AB9"),
  

  #pathogenesis = setNames(c("#d42e22", "#007BA7", "#93C83E"), c("Pathogenic", "Intermediate", "Saprophytic")),
  pathogenesis = setNames(c("#F94040", "#B856D7", "#008000"), c("Pathogenic", "Intermediate", "Saprophytic")),
  lepto_species = setNames(c("#008000", "#008000", "#B856D7", "#9e4a9b", "#F94040", "#FF8080", "#FF8080"), c("Leptospira biflexa", "Leptospira ilyithenensis", "Leptospira kmetyi", "Leptospira wolffii", "Leptospira borgpetersenii", "Leptospira interrogans" , "Leptospira interrogans s.Copenhageni")),
  host_species = setNames(c("#eb8934", "#9e4a9b", "#D2F56E", "#F5D96E", "#9F6EF5"), c("Bos taurus", "Homo sapiens", "Mesocricetus auratus", "Rattus norvegicus", "Canis lupus"))
  # #eb6654 #60d5db
)
